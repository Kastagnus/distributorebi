...
class ProductCreateForm(forms.ModelForm):
    class Meta:
        model = Product
        fields = ['name', 'name_en', 'name_ru' ,'description', 'description_en', 'description_ru' ,'price', 'unit', 'size', "image"]
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name in ['level_0_category', 'level_1_category', 'level_2_category']:
            field = self.fields.get(field_name)
            if field:
                field.label_from_instance = lambda obj: obj.get_translated_name()

        if self.instance and self.instance.pk and self.instance.category:
            category = self.instance.category
            if category.level == 2:
                print("I am printing to show up to level 2")
                ...
                print("I am printing to show up to level 1")
